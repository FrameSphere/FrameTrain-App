...
## Corpus Check
- 237 files · ~351,026 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2766 nodes · 6186 edges · 159 communities (144 shown, 15 thin omitted)
...
Cohesion: 0.15
Nodes (24): analyzeError(), AppliedEditInfo, calculateAffectedLines(), ChatSession, deleteScript(), devProgressPercent(), DevTrainErrorModal(), DevTrainErrorModalProps (+16 more)

### Community 5 - "DevTestPanel.tsx"
Cohesion: 0.12
Nodes (26): AppliedEditInfo, calculateAffectedLines(), ChatSession, deleteScript(), DevTestErrorModal(), DevTestPanelProps, escapeHtml(), generateDefaultTestScript() (+18 more)

### Community 6 - "SynapseAICoachPanel.tsx"
Cohesion: 0.06
Nodes (43): adjustParamsFix(), applyAutoFix(), AutoFixResult, insertBridgeFix(), TODO: Implementiere topologisches Sorting der Nodes, TODO: Toast anzeigen, TODO: Error Toast anzeigen, removeNodeFix() (+35 more)
...
Cohesion: 0.10
Nodes (29): firstUsableLoss(), lossImprovementPct(), LossPointLike, cat(), t(), analyzeError(), BigLossChart(), ConfigSummary() (+21 more)
...
Cohesion: 0.11
Nodes (27): AnalysisView(), deleteSession(), DevScriptEditor(), extractLabelField(), extractTextField(), getDisplayText(), getSideInfo(), LABEL_KEYS (+19 more)
...
Cohesion: 0.10
Nodes (26): AIAssistantSettingsPanel(), AISetupScreen(), AISetupScreenProps, DependencyStatus, FirstLaunchSetup(), GpuInfo, InstallProgress, LanguageSelectScreen() (+18 more)

### Community 23 - "codeEdits.ts"
Cohesion: 0.29
Nodes (12): anchorReplace(), applyAllEdits(), applyEdit(), collapseSpaces(), findLineWindow(), nonEmptyLines(), normalizeTabs(), parseEdits() (+4 more)
...
Cohesion: 0.05
Nodes (35): ABC, Any, core/config.py – TrainingConfig ================================ Gemeinsame…, Hilfsmethode: Plugin-spezifischen Wert aus plugin_config holen., TrainingConfig, build_training_arguments(), cap_eval_dataset(), classification_scores() (+27 more)
...
Cohesion: 0.06
Nodes (57): AICoachOpenDetail, onOpenAICoach(), APP_OVERVIEW, Bilingual, buildCoachSystemPrompt(), buildPageContext(), CoachAction, coercePatchFromRecord() (+49 more)
...
Cohesion: 0.13
Nodes (19): PROVIDER_META, ProviderMeta, CommunityNameErrorModal(), InstallProgress, SettingsProps, SettingsTab, STATUS_COLOR, StoredTicket (+11 more)

### Community 33 - "VersionManager.tsx"
Cohesion: 0.15
Nodes (18): CoachPromptOptions, PageContextInput, AIAnalysisReport, LanguageSelectScreenProps, formatBytes(), formatDate(), formatDuration(), getFileIcon() (+10 more)
...
Cohesion: 0.11
Nodes (25): addToLocalLibrary(), AUTHOR_KEY(), DuplicateNameError(), FRAMEWORKS, getLocalKey(), getStoredAuthorName(), isRejected(), LibraryScript (+17 more)
...
### Community 47 - ".status"
Cohesion: 0.09
Nodes (14): _audio_in(), _class_dirs(), Plugin, Path, TrainingConfig, Plugin, TrainingConfig, _detect_columns() (+6 more)
...
### Community 51 - "errorReport.ts"
Cohesion: 0.14
Nodes (11): App(), AppErrorBoundary, Props, State, APP_ERROR_ENDPOINT, AppErrorReport, installGlobalErrorReporting(), reportRuntime() (+3 more)
...
Cohesion: 0.14
Nodes (17): ModelSelectorProps, State, hfEncoderPlugin, DetectionResult, KNOWN_UNSUPPORTED, knownKeyFromId(), ModelDetectionInfo, PLUGINS (+9 more)
...
### Community 65 - "ir.py"
Cohesion: 0.06
Nodes (47): get_dataloaders(), _infer_input_features(), CanvasGraphIR, DataLoader, DataLoaders for Canvas IR training., _apply_dense_initializer(), DynamicGraphModule, CanvasGraphIR (+39 more)
...
Cohesion: 0.36
Nodes (6): containsToken(), detectHFEncoder(), HF_ENCODER_SUPPORTED_MODEL_TYPES, modelNameSegment(), NON_ENCODER_TOKENS, SUPPORTED_MODEL_TYPES
...
### Community 75 - "yolo/index.ts"
Cohesion: 0.38
Nodes (4): detectYOLO(), Detection, InferenceResult, YOLOTestPlugin()
...
Cohesion: 0.07
Nodes (35): PageId, AnalysisPreview(), DevTestPanel(), checkHfModelSupport(), DeleteConfirmDialog(), DeleteDialogProps, formatBytes(), formatDate() (+27 more)
...
Cohesion: 0.19
Nodes (10): audioClassificationPlugin, AudioTestPlugin(), canvasPlugin, GenericTestPanel(), GenericTestPanelProps, TopPred, hfImageClassificationPlugin, HFImageTestPlugin() (+2 more)

### Community 98 - "CodeAISidebar"
Cohesion: 0.16
Nodes (15): AutoMode, buildAutoSystemPrompt(), parseAutoAction(), extractFullPythonCode(), removeEditBlocks(), CodeAISidebar(), loadChatSessions(), makeSessionTitle() (+7 more)
...
### Community 132 - "csvRows.ts"
Cohesion: 0.73
Nodes (4): hasOpenQuote(), joinQuotedLines(), parseDelimitedRows(), splitDelimitedLine()

### Community 133 - "DatasetUpload.tsx"
Cohesion: 0.09
Nodes (28): openAICoach(), DatasetCard(), DatasetCardProps, DatasetStructureGuide(), DatasetUpload(), DeleteDialog(), FilterOptions, formatBytes() (+20 more)
...
Cohesion: 0.12
Nodes (17): CanvasModelMetadata, exportCanvasNetworkToModelLibrary(), CanvasGraphIR, LayerConfig, ModelGraphConfig, CanvasDesign, deleteBtn, deleteModelDesign() (+9 more)

### Community 151 - "Plugin"
Cohesion: 0.21
Nodes (5): _class_dirs(), _images_in(), Plugin, Path, TrainingConfig
...
- **Why does `useLanguage()` connect `useLanguage` to `TrainingPanel.tsx`, `DevTrainPanel.tsx`, `DatasetUpload.tsx`, `DevTestPanel.tsx`, `LanguageContext.tsx`, `SynapseAICoachPanel.tsx`, `AnalysisPanel.tsx`, `TrainingDashboard.tsx`, `LaboratoryPanel.tsx`, `ModelLibrary.tsx`, `plugins/datasetCompat.ts`, `SynapseBuilder.tsx`, `FloatingAICoach.tsx`, `Settings.tsx`, `VersionManager.tsx`, `DiffViewer.tsx`, `OpenLibraryModal.tsx`, `nodeTypes.ts`, `SynapseAIPanel.tsx`, `TrainingConsole.tsx`, `registry.ts`, `ModelManager.tsx`, `CodeAISidebar`?**
